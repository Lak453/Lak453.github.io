...
<a href="{{ site.url }}/Resume/" style="color:#888;display:inline-block;margin:0 8px;">All</a>{% for tag in taglist %}<a href="{{ site.url }}/fragments/?tag={{ tag }}" style="color:#888;display:inline-block;margin:0 8px;">{{ tag }}</a>{% endfor %}
